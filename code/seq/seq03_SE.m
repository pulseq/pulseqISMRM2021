...
rf_ref = mr.makeBlockPulse(pi,'Duration',rfDur, 'system', system, 'PhaseOffset' ,pi/2 , 'use', 'refocusing'); % parameter 'use' is needed for the proper k-space calculation
...
% show the entire sequence showing the block structure
seq.plot('showBlocks',1,'timeDisp','ms');
