...
gxPre = mr.makeTrapezoid('x','Area',-gx.area/2-deltak/2,'Duration',2e-3,'system',sys); % we need this "deltak/2" because of the ADC sampling taking place in th middle of the dwell time
...
seq.plot(); %seq.plot('timeRange',[0 2*TR]);
